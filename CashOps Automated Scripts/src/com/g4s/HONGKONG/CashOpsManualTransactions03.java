  ...
  @Test(description = "Authorize 03 transactions", priority = 6, enabled = true)
   ...
   @Test(description = "Increment values for Canister and Seal Number", priority = 6)
	public void incrementValues() throws Exception 
	{
        ...
        String second100 = Integer.toString(secondR100Notes);
			...
			try 
			{
				...
				workingDir = System.getProperty("user.dir");
		        FileOutputStream out = new FileOutputStream(workingDir+"\\Resources\\HONGKONG\\values.properties");
		        FileInputStream in = new FileInputStream(workingDir+"\\Resources\\HONGKONG\\values.properties");
	...
	public void suiteSetUp() 
	{
			...
			workingDir = System.getProperty("user.dir");
			datafile = new UIMap(workingDir + "\\Resources\\HONGKONG\\datafile.properties");
			
			// Get current working directory and load the data file
						workingDir = System.getProperty("user.dir");
						values = new UIMap(workingDir + "\\Resources\\HONGKONG\\values.properties");
			// Get the object map file
			uimap = new UIMap(workingDir + "\\Resources\\HONGKONG\\locator.properties");
