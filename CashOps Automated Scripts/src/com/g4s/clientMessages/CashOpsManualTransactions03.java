package com.g4s.clientMessages;
...

{
	...
	public void incrementValues() throws Exception 
	{
		...
		String second200 = Integer.toString(secondR200Notes);
			try 
			{
				...
				workingDir = System.getProperty("user.dir");
		        FileOutputStream out = new FileOutputStream(workingDir+"\\Resources\\values.properties");
		        FileInputStream in = new FileInputStream(workingDir+"\\Resources\\values.properties");
	...
	public void suiteSetUp() 
	{
			...
			// Get current working directory and load the data file
						workingDir = System.getProperty("user.dir");
						values = new UIMap(workingDir + "\\Resources\\values.properties");
