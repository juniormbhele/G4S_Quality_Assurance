...
public class eCommerceTest 
{
	...
	public void setUp() throws Exception 
      ...
      // Step 5. In the list of all mobile , select ‘SORT BY’ dropdown as ‘name’		
		...
		{
			System.out.println("You can't add more than 500 QTY to the cart");
			
			//Emptying the Cart
			driver.findElement(By.xpath("//*[@id=\"empty_cart_button\"]/span/span")).click();
			
			String CartStatus = driver.findElement(By.xpath("//*[@id=\"top\"]/body/div/div/div[2]/div/div/div[2]/p[1]")).getText();
			
			if (CartStatus.contains("You have no items in your shopping cart."))
			{
				System.out.println("You have emptied the your cart");
			}
			else
			{
				System.out.println("You can't empty the your cart");
			}
		}
		else
		{
			System.out.println("You can add more than 500 QTY to the cart");
